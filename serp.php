...
if( $_thumbs ){
	$url = "http://feed.peakclick.com/res.php?aff=$_aff&subaff=$_subaff" . ( $keyword_feed != "" ? "&keyword=" . urlencode( $keyword_feed ) : "" ) . "&num=$_numResults&ip=".$_GET['yourip']."&thumbs=1&filter=1";
	$lines = file( $url );
	...
	$url = "http://feed.peakclick.com/res.php?aff=$_aff&subaff=$_subaff" . ( $keyword_feed != "" ? "&keyword=" . urlencode( $keyword_feed ) : "" ) . "&num=$_numResults&ip=".$_GET['yourip']."&filter=1";
	$lines = file( $url );
